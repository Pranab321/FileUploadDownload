    ...
    public class FileController : ControllerBase
    {
        ...
        {           
            ...
            if (fileDetail != null)
            {
             ...
             //   Stream file = System.IO.File.OpenRead(fileReadPath);
                byte[] filepaths=System.IO.File.ReadAllBytes(fileReadPath);
                //var dfile = File(file, "application/octet-stream", fileDetail.FileName);
                return File(filepaths, "application/x-msdownload", fileDetail.FileName);
                //return Ok(dfile);
            }
            else
            {
